      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            if($paciente == ""){
            ?>
            <td class="text-center"><a class="btn btn-success btn-sm" style="color:#fff" href="agenda.php?<?php echo "medico=$idMedico&paciente=$idpaciente&dia=$dia&hora=$hora&especialidade=$especialidadeMedica_id"?>"  role="button"><i class="fas fa-plus-circle"></i>&nbsp;Adicionar</a></td>
            <?php
            }else{
            ?>
