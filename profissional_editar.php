...
if(isset($_FILES['arquivo'])) {
    ...
    $sql2 = "UPDATE profissional SET profissional.nome='$nome', profissional.especialidade='$especialidade', profissional.celular='$celular', profissional.registro='$registro' WHERE profissional.usuario_id = $id";
    $resultado2 = $conexao->query($sql2);
